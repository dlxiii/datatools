...
python stn2map.py 100 './ajiro/1991-2017_prec.csv' \
'./chiba/1991-2017_prec.csv' \
'./chichibu/1991-2017_prec.csv' \
'./choshi/1991-2017_prec.csv' \
'./irozaki/1991-2017_prec.csv' \
...
rin = ncout.createVariable('rin', np.float64, ('time','lon','lat'), fill_value=np.nan)
rin.standard_name = 'precipitation'
rin.long_name = 'precipitation'
rin.units = 'm/s'
rin.axis = 'P'
print(rin)
...
lat[:] = x
rin[:,:,:] = zz
print("-- Wrote data, rin.shape is now ", rin.shape)
# read data back from variable (by slicing it), print min and max
print("-- Min/Max values:", rin[:,:,:].min(), rin[:,:,:].max())

#Add global attributes
ncout.type    = 'Meteology File'
ncout.title   = 'Precipitation'
