...
python stn2map.py 100 './ajiro/1991-2017_pres.csv' \
'./chiba/1991-2017_pres.csv' \
'./chichibu/1991-2017_pres.csv' \
'./choshi/1991-2017_pres.csv' \
'./irozaki/1991-2017_pres.csv' \
...
prs = ncout.createVariable('prs', np.float64, ('time','lon','lat'), fill_value=np.nan)
prs.standard_name = 'pressure'
...
lat[:] = x
prs[:,:,:] = zz
print("-- Wrote data, prs.shape is now ", prs.shape)
# read data back from variable (by slicing it), print min and max
print("-- Min/Max values:", prs[:,:,:].min(), prs[:,:,:].max())

#Add global attributes
ncout.type    = 'Meteology File'
ncout.title   = 'Atmospheric pressure'
